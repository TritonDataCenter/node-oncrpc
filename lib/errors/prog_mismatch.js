...
RpcProgramMismatchError.prototype.toString = function toString() {
    return (sprintf('RpcProgramMismatchError low=%d, high=%d',
        this.mismatch_info.low, this.mismatch_info.high));
};
