...
function PortmapUnsetCall(opts) {
    ...
    this._rpc_portmap_unset_call = true; // MDB
}
util.inherits(PortmapUnsetCall, RpcCall);


PortmapUnsetCall.prototype._transform = function _transform(chunk, enc, cb) {
    if (this.incoming) {
...
PortmapUnsetCall.prototype.writeHead = function writeHead() {
...
PortmapUnsetCall.prototype.toString = function toString() {
    var fmt = '[object PortmapUnsetCall <xid=%d, mapping=%j>]';
...
module.exports = {
    PortmapUnsetCall: PortmapUnsetCall
};
